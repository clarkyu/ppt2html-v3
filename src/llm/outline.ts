...
2. 版式看内容形态选择：有真实数字支撑的结论→big-number；流程/步骤/发展史→timeline；方案取舍→comparison；正反两面→two-col；权威引言(真实可溯源)→quote；连贯叙述的背景/故事→image-text；并列观点→bullets。**不要连续超过 2 页 bullets**；若本部分内容适合，安排一页 big-number / quote / timeline / comparison 制造记忆点——不硬凑。
