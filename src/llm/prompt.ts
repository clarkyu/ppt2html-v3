...
export function contextBlock(topic: string, opts: GenerateOptions): string {
  ...
  // User-pasted source material: facts get quoted faithfully, an embedded
  // outline drives the structure. This flows to every generation path that
  // builds on contextBlock (quick deck, structure, part pages, segments).
