...
3. 【版式看内容形态选择】不是为了花哨：
   - 有一个真实数字支撑的结论 → big-number；流程 / 步骤 / 发展历程 → timeline；
...
6. 【讲述有弧线 + 备注到位】开场用钩子(反常识事实 / 提问 / 场景)，中间循序展开，收尾给行动建议或升华——像一位优秀老师在讲课。**每个内容页都写讲者备注 note**：2~3 句比页面文字更展开的口播要点，外加一个可向听众提的互动问题。
